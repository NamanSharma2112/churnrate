...
export const CommandMenu = (
  ...
  return (
    ...
    >
     ...
     <Command.Group heading='Teams' className='text-sm mb-3 text-stone-400'>
<Command.Item className='flex cursor-pointer transition-colors p-2 text-sm text-stone-900 hover:bg-stone-200 rounded items-center gap-2'>
    <FiPlus/>
    Invite Team Member
</Command.Item>
<Command.Item className='flex cursor-pointer transition-colors p-2 text-sm text-stone-900 hover:bg-stone-200 rounded items-center gap-2'>
